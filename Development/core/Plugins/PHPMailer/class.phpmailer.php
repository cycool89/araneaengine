...
function &email()
{
    if (is_null(PHPMailer::$Instace))
    {
        PHPMailer::$Instace = new PHPMailer();
        PHPMailer::$Instace->Hostname = _DOMAIN;
        PHPMailer::$Instace->Host = _DOMAIN;
        PHPMailer::$Instace->IsHTML(true);
        PHPMailer::$Instace->AddReplyTo(_EMAIL, _CNAME);
    }
    return PHPMailer::$Instace;
}
