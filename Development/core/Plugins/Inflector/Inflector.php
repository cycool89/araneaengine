...
class Inflector
{
    ...
    /**
     * Converts string to URL frienldy form.
     *
     * This method converts Hello World to hello-world ...
     *
     * @access public
     * @static
     * @param    string    $string    String to get its short-url value
     * @return string URLized representation of given string.
     */
    
    function urlize($string)
    {
        $fromLetters = array(
            'á','í','ű','ő','ü','ö','ú','ó','é','Á','Í','Ű','Ő','Ü','Ö','Ú','Ó','É','!','?',':','$',',','"','\''
        );
        $toLetters   = array(
            'a','i','u','o','u','o','u','o','e','a','i','u','o','u','o','u','o','e','-','-','-','-','-','-','-'
        );
        $string = strtolower($string);
        $string = str_replace($fromLetters,$toLetters,$string);
